  ...
  return (
    ...
    >
      <form className="mx-auto max-w-2xl w-full p-5 glass rounded-2xl">
        ...
        <h2 className="text-white text-center mt-6 font-semibold md:text-2xl text-xl">
          Download Form
        </h2>
        ...
        <button className="hover:bg-[#0056b3] w-full mt-6 font-medium px-10 py-4 cursor-pointer transition-all duration-500 bg-[#007bff] text-white   rounded-lg ">
          Download and Submit
        </button>
      </form>
    </div>

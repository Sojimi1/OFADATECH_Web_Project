    ...
    <div className="bg-[#333333] p-4 md:pt-12 w-full pt-8">
      <div className="max-w-7xl w-full mx-auto grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 md:gap-5 gap-7">
        <div className="">
          ...
          <p className="text-zinc-200 py-5">
            A supermarket of skills to learn and to earn an income.
          </p>
        ...
        <div className="text-white lg:pl-20">
          ...
          <ul className="pt-5 space-y-2">
            ...
            <li>
              <Link href="/form">Download Form</Link>
            </li>
            <li>
        ...
        <div className="text-white lg:pl-5">
          ...
          <div className="flex items-start gap-2 mt-5">
            ...
            <p>
              Papalanto Road, Asa Baala/Mosadomi Village, Ofada, Obafemi-Owode
              L/g Ogun State.
            </p>
          </div>
          <div className="flex items-start gap-2 mt-5">
            ...
            <a
              href="mailto:ofadatechnicalschool@gmail.com"
              className="text-balance"
            >
              ofadatechnicalschool@ gmail.com
            </a>
          </div>
          <div className="flex items-start gap-2 mt-5">
      ...
      <p className="text-zinc-200 font-medium text-center border-t pt-4 mt-14">
        OFATECH © Copyrights 2026 /{" "}
        <span className="font-light"></span> / All Rights
        Reserved.
      </p>
    </div>
  );

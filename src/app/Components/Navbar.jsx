      ...
      <div className="bg-white border-b sticky top-0 p-4 w-full z-40">
        <div className="flex relative items-center justify-between max-w-7xl w-full mx-auto">
          <FaBars
            ...
            className="text-zinc-700 text-xl md:hidden transition-all duration-500 hover:text-black cursor-pointer"
          />
          <Link href="/">
          ...
          <GrSearch
            ...
            className="text-zinc-700 text-xl transition-all duration-500 hover:text-black cursor-pointer"
          />
            ...
            <div className="bg-white p-2 rounded-lg max-w-[17.8rem] fadeIn absolute md:top-16 top-14 md:right-5 right-2 z-10">
              <div className=" flex items-center">
                <input
                  ...
                  className="p-3 border-r-0 rounded-l-lg focus:border-zinc-300 border"
                />
          ...
          <div
            className={`absolute w-full z-20 top-[4.5rem] overflow-hidden transition-all duration-500 ${
              navbar ? "h-72" : "h-0"
            } `}
          >
            <ul className="md:hidden border border-t-0 w-full max-w-[95%] mx-auto flex-col flex items-center bg-white text-[#555555] font-medium">
              <li className="w-full text-center">
                <Link
                  className="transition-all border-b w-full p-4 block  duration-500 hover:text-black"
                  href="/"
                >
                  Home
                </Link>
              ...
              <li className="w-full text-center">
                <Link
                  className="transition-all p-4 block  duration-500 hover:text-black"
                  href="/"
                >
                  Contact
                </Link>
